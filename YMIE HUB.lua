...
for i,v in pairs(game.Workspace.YMIEaSpawner:GetChildren()) do
    if v:IsA("Tool") then
        if RealFruitESP then 
            if not v.Handle:FindFirstChild('NameEsp'..Number) then
                local bill = Instance.new('BillboardGui',v.Handle)
...
Tabs.profile:AddParagraph({
        ...
        Content = "https://discord.gg/4ttbV9wjQV"
    })
...
local listfastattack = {'0.01','0.05','0.015','0.001','0.1','0.005','0','0.02'}
    ...
    _G.YmieHub_Mode = Value
	if _G.YmieHub_Mode == "0.1" then
		_G.Fast_Delay = 0.1
    elseif _G.YmieHub_Mode == "0.05" then
		_G.Fast_Delay = 0.05
	elseif _G.YmieHub_Mode == "0.005" then
        _G.Fast_Delay = 0.005
    elseif _G.YmieHub_Mode == "0.001" then
		_G.Fast_Delay = 0.001
    elseif _G.YmieHub_Mode == "0" then
		_G.Fast_Delay = 0
    elseif _G.YmieHub_Mode == "0.01" then
        _G.Fast_Delay = 0.01
    elseif _G.YmieHub_Mode == "0.015" then
        _G.Fast_Delay = 0.015
    elseif _G.YmieHub_Mode == "0.02" then
        _G.Fast_Delay = 0.02
	end
end)
    ...
    spawn(function()
		while wait() do
			if _G.AutoObservationHakiV2 then
				...
				if game.Players.LocalPlayer.Backpack:FindFirstChild("YMIEa") and  game.Players.LocalPlayer.Backpack:FindFirstChild("Apple") and game.Players.LocalPlayer.Backpack:FindFirstChild("Pineapple") then
					repeat 
						Tween(CFrame.new(-12444.78515625, 332.40396118164, -7673.1806640625)) 
						wait() 
					until not _G.AutoObservationHakiV2 or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-12444.78515625, 332.40396118164, -7673.1806640625)).Magnitude <= 10
				...
				elseif game.Players.LocalPlayer.Backpack:FindFirstChild("Fruit Bowl") or game.Players.LocalPlayer.Character:FindFirstChild("Fruit Bowl") then
					...
					for i,v in pairs(game.Workspace:GetDescendants()) do
						if v.Name == "Apple" or v.Name == "YMIEa" or v.Name == "Pineapple" then
...
Fluent:Notify({
    Title = "YMIEHub",
    Content = "@"..game.Players.LocalPlayer.Name.."https://discord.gg/4ttbV9wjQV",
    Duration = 8
})
